...
function AuthNavLink({ href, children }) {
      ...
      <div className="flex w-full flex-col justify-center px-5">
        ...
        >
          <div className="flex flex-col items-center">
            <Link to={'/'} className="mb-4 inline-block max-w-[64px] lg:mb-9">
              {/* <Image src={siteConfig.icon} alt={siteConfig.title} /> */}
              <img src={require('../../assets/images/logo.png')} alt='logo' />
            </Link>
            <Title
              as="h2"
              className="mb-4 text-center text-[28px] font-bold leading-snug md:text-3xl md:!leading-normal lg:mb-10 lg:text-4xl"
            >
              <p>Sazs Apps</p>
            </Title>
          </div>
